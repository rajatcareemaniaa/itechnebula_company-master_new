      ...
      <div class="row">
        ...
        <div class="col-lg-10">
          <div class="row justify-content-center align-items-center">
            <div class="col-md-8">
              <h1 class="ck_gs_2_text1">ચાલો તેને સ્નેપી રાખીએ, શું આપણે? પરંતુ પ્રથમ, ચાલો નમ્ર બનીએ <br> તમારું નામ શું છે?</h1>
            </div>
          </div>
          ...
          <div class="row justify-content-center align-items-center">
            <div class="col-md-7 mt-5 text-center">
              <form method="post" action="" enctype="multipart/form-data">
                <input type="text" name="userName" placeholder="તમારું પ્રથમ નામ દાખલ કરો" class="ck_gs_2_input1 text-center" />
                <button type="submit" class="ck_gs_2_btn mt-5"> ચાલુ રાખો <img src="Assets/Images/gs_right_arrow.png" class="img-fluid" style="width: 75px; height: 25px;"> </button>
              </form>
            </div>
          </div>
        </div>
