          ...
          <form method="post" action="" enctype="multipart/form-data">
            ...
            <div class="row justify-content-center align-items-center">
              <div class="col-md-7 mt-5">
                <input type="text" placeholder="MESSAGE" name="message" alt="" class="ck_gs_9_input1 mx-2 text-center" />
                <button class="ck_gs_9_btn mt-5"> Continue <img src="Assets/Images/gs_right_arrow.png" class="img-fluid" style="width: 75px; height: 25px;"> </button>
              </div>
            </div>
