      ...
      <div class="row">
        ...
        <div class="col-lg-10">
          <div class="row justify-content-center align-items-center">
            <div class="col-md-8">
              <h1 class="ck_gs_6_text1">તમને શા માટે લાગે છે કે આ IT સોલ્યુશન તમારી સંસ્થા માટે જરૂરી છે?
              </h1>
            </div>
          </div>
          <form method="post" action="" enctype="multipart/form-data">
            ...
            <div class="row justify-content-center align-items-center">
              <div class="col-md-7 mt-5">
                <input type="text" placeholder="સંદેશ" name="message" class="ck_gs_6_input1 mx-2 text-center" />
                <button type="submit" class="ck_gs_6_btn mt-5"> ચાલુ રાખો<img src="https://ik.imagekit.io/cowe9tcww/Assets/Images/gs_right_arrow.png?updatedAt=1706168306779" class="img-fluid" style="width: 75px; height: 25px;"> </button>
              </div>
            </div>
