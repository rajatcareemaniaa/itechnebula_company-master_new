          ...
          <div class="row justify-content-center align-items-center">
            <div class="col-md-8">
              ...
              if (isset($_SESSION["userName"]) && !empty($_SESSION["userName"])) {
                ...
                echo '<h1 class="ck_gs_text3">મહાન! તમારું ઈમેલ સરનામું શું છે?</h1>';
              }
              ?>
            </div>
          ...
          <form action="" method="post">
            <div class="row justify-content-center align-items-center">
              <div class="col-md-7 mt-5">
                <input type="text" placeholder="તમારું ઈમેલ એડ્રેસ લખો*" name="userEmail" alt="" class="ck_gs_3_input1 mx-2 text-center" />
              </div>
            </div>
            ...
            <div class="row">
              <div class="mt-5 ">
                ...
                <button type="submit" class="ck_gs_3_btn"> શરૂ કરો <img src="Assets/Images/gs_right_arrow.png" style="width: 75px; height: 25px;"> </button>
