        ...
        <div class="col-lg-10">
          <form method="post" action="" enctype="multipart/form-data">
            <div class="row justify-content-center align-items-center">
              <div class="col-md-8">
                <h1 class="ck_gs_5_text1">તમારો વ્યવસાય કયા શહેરમાં આધારિત છે?</h1>
              </div>
            </div>
            ...
            <div class="row justify-content-center align-items-center">
              <div class="col-md-7 mt-5">
                <div class="location-container">
                  <input type="text" placeholder="શહેર" name="city" id="city" class="ck_gs_5_input1 mx-2 text-center" />
            ...
            <div class="row">
              <div class="mt-5 ">
                <button type="submit" class="ck_gs_5_btn"> ચાલુ રાખો <img src="https://ik.imagekit.io/cowe9tcww/Assets/Images/gs_right_arrow.png?updatedAt=1706168306779" class="img-fluid" style="width: 75px; height: 25px;"> </button>
              </div>
            </div>
          </form>
        </div>
