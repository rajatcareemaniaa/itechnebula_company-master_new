      ...
      <div class="row">
        ...
        <div class="col-lg-10">
          <div class="row justify-content-center align-items-center">
            <div class="col-lg-8">
              <h1 class="ck_gs_12_text1">શું તમારી પાસે આ પ્રોજેક્ટ માટે બજેટ છે?
          ...
          <div class="row justify-content-center align-items-center">
            <div class="col-md-7">
              <div class="range-container mt-5">
                ...
                <button class="ck_gs_12_btn mt-5"> ચાલુ રાખો <img src="https://ik.imagekit.io/cowe9tcww/Assets/Images/gs_right_arrow.png?updatedAt=1706168306779" class="img-fluid" style="width: 75px; height: 25px;"> </button>
