      ...
      <div class="row">
        ...
        <div class="col-lg-10">
          <div class="row justify-content-center align-items-center">
            <div class="col-md-8">
              <h1 class="ck_gs_14_text1">આ ઉકેલને સંપૂર્ણ રીતે અમલમાં મૂકવા માટે તમારે ક્યારે જરૂર છે?</h1>
            </div>
          </div>
          ...
          <div class="row">
            <div class=" ">
              <a href="Gs_15.php"><button class="ck_gs_14_btn"> ચાલુ રાખો <img src="https://ik.imagekit.io/cowe9tcww/Assets/Images/gs_right_arrow.png?updatedAt=1706168306779" class="img-fluid" style="width: 75px; height: 25px;"> </button></a>
            </div>
          </div>
        </div>
      </div>
