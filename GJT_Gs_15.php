      ...
      <div class="row">
        ...
        <div class="col-lg-10">
          <div class="row justify-content-center align-items-center">
            <div class="col-md-8">
              <h1 class="ck_gs_15_text1">શું ત્યાં કોઈ નિર્ણાયક સીમાચિહ્નો અથવા સમયમર્યાદાઓ છે જેના વિશે આપણે જાણવું જોઈએ?
          ...
          <div class="row">
            <div class="mt-5 ">
              <a href="Gs_16.php"><button class="ck_gs_15_btn"> ચાલુ રાખો<img src="https://ik.imagekit.io/cowe9tcww/Assets/Images/gs_right_arrow.png?updatedAt=1706168306779" class="img-fluid" style="width: 75px; height: 25px;"> </button></a>
            </div>
          </div>
        </div>
      </div>
