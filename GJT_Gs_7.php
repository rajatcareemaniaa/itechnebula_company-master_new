      ...
      <div class="row">
        ...
        <div class="col-lg-10">
          <div class="row justify-content-center align-items-center">
            <div class="col-md-8">
              <h1 class="ck_gs_7_text1">આ સોલ્યુશનમાં તમારી સંસ્થા માટે કઈ વિશિષ્ટ કાર્યો અથવા સુવિધાઓ આવશ્યક છે?
              </h1>
            </div>
          </div>
          ...
          <div class="row justify-content-center align-items-center">
            ...
            <input type="text" placeholder="સંદેશ" name="message" class="ck_gs_7_input1 mx-2 text-center" />
             <button class="ck_gs_7_btn mt-5"> ચાલુ રાખો <img src="https://ik.imagekit.io/cowe9tcww/Assets/Images/gs_right_arrow.png?updatedAt=1706168306779" class="img-fluid" style="width: 75px; height: 25px;"> </button>
