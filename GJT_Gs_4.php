        ...
        <div class="col-lg-10">
          <div class="row justify-content-center align-items-center">
            <div class="col-md-8">
              ...
              if (isset($_SESSION["userName"]) && !empty($_SESSION["userName"])) {
                ...
                echo '<h1 class="ck_gs_4_text1">હા! અમે ખાતરી કરવા માંગીએ છીએ કે iTechnebula તમારા વ્યવસાય માટે યોગ્ય છે. શું અમે તમને થોડા પ્રશ્નો પૂછી શકીએ છીએ</h1>';
              }
              ?>
            </div>
          </div>
          ...
          <div class="row justify-content-center align-items-center">
            <div class="col-md-7 mt-5">
              <p class="ck_gs_4_text2">પ્રથમ, તમે શું વેચો છો?</p>
            </div>
          </div>
              ...
              <div class="card">
                <form action="" method="post">
                  <div class="card-content">
                    ...
                    <button type="submit" name="userChoice" value="Product" class="ck_Gs_4_btn1 mt-5">ઉત્પાદનો</button>
                  </div>
                </form>
              </div>
              <div class="card">
                <form action="" method="post">
                  <div class="card-content">
                    ...
                    <button type="submit" name="userChoice" value="Service" class="ck_Gs_4_btn1 mt-5">સેવા</button>
                  </div>
                </form>
              </div>
            </div>
