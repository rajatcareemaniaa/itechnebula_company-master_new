      ...
      <div class="row">
        ...
        <div class="col-lg-10">
          <div class="row justify-content-center align-items-center">
            <div class="col-md-8">
              <h1 class="ck_gs_21_text1">શું માપનીયતા આ પ્રોજેક્ટ માટે વિચારણા છે?
          ...
          <div class="row justify-content-center align-items-center">
            <div class="col-md-7 mt-5">
              <input type="text" placeholder="નામ દાખલ કરો" alt="" class="ck_gs_21_input1 mx-2 text-center" />
            </div>
          </div>

          <div class="row">
            <div class="mt-5 ">
              <a href="Gs_22.php"><button class="ck_gs_21_btn"> ચાલુ રાખો <img src="https://ik.imagekit.io/cowe9tcww/Assets/Images/gs_right_arrow.png?updatedAt=1706168306779" class="img-fluid" style="width: 75px; height: 25px;"> </button></a>
            </div>
          </div>
        </div>
      </div>
